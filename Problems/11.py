...
for y in range(20):
	for x in range(20):  #gremo cez vse clene matrike
		if x <= 16: #v desno
			resitev = max(produkt_4ih(x, y,  1, 0), resitev)
		if y <= 16: #navzdol
			resitev = max(produkt_4ih(x, y,  0, 1), resitev)
		if x <= 16 and y <= 16: #diagonalno desno
